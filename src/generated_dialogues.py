...
output_file = input_mode+"_"+scenario+"_winner"+".xlsx"
    ...
    for n in range(3):
        ...
        if dialogue[0] in update_users and dialogue[1] in update_users and dialogue[2] in update_users:
            ...
            if user_raw_gaze_data:
                ...
                gaze_history, objects_timestamps = pyGaze.compute_gaze_history_closest_object(user_raw_gaze_data["gaze_data"], start_time, 15.0,8.0, 8.0, excluded_objects, 5.0, 0.5, 0.08)
...
# # Create a formatted list of dialogues
# formatted_dialogues = [
#     {
#         "Interaction 1": dialogue[0],
#         "Interaction 2": dialogue[1],
#         "Interaction 3": dialogue[2]
#     }
...
# dialogues_df = pd.DataFrame(formatted_dialogues)

# # Save to an Excel file
# output_file = "generated_dialogues.xlsx"
