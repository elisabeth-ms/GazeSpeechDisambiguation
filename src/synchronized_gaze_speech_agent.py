...
def key_listener(llm_handler,stream, gaze_manager, transcription_queue, plot_speech_queue, plot_gaze_queue, print_emojis =False):
    ...
    while True:
        ...
        if key == 's':
            ...
            if stream.running:
                transcript, gaze_history, objects_timestamps = None, None, None
                ...
                for user_raw_gaze_data in all_users_raw_gaze_data:
                    ...
                    gaze_history, objects_timestamps = pyGaze.compute_list_closest_objects_gaze_history(user_raw_gaze_data["gaze_data"], gaze_start_time, 15.0,10.0, 10.0, excluded_objects, 5.0, 0.5, 0.02)
                ...
                while not transcription_queue.empty():
                    ...
                    print("Gaze timestamps: ", objects_timestamps)
                    
                    input = merge_gaze_word_intervals(objects_timestamps, word_data)
                ...
                if transcript and gaze_history:
                    ...
                    llm_handler.play_with_functions(input=input, person_name=person_name)
